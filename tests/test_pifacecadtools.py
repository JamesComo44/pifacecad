...
class TestLCDScanf(unittest.TestCase):
    ...
    def test_scanner(self):
        ...
        scanner = pifacecad.tools.LCDScanf(
            format="%i %2c %m%r", custom_values=("orange", "apple"), cad=self.cad
        )
        answer = scanner.scan()
...
class TestLCDQuestion(unittest.TestCase):
    def test_question(self):
        ...
        the_answers = ("Because I said so", "Why not?", "Maybe", "42")

        question = pifacecad.tools.LCDQuestion(question="Why?", answers=the_answers)
