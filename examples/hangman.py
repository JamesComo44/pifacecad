...
stages = [
    # stage 0
    {
        "top-left": pifacecad.LCDBitmap([0x0, 0x0, 0xF, 0x8, 0x8, 0x8, 0x8, 0x8]),
        "top-middle": pifacecad.LCDBitmap([0x0, 0x0, 0x1C, 0x4, 0x0, 0x0, 0x0, 0x0]),
        "top-right": pifacecad.LCDBitmap([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
        "bottom-left": pifacecad.LCDBitmap([0x8, 0x8, 0x8, 0x8, 0x8, 0x8, 0x8, 0x1F]),
        "bottom-middle": pifacecad.LCDBitmap([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1F]),
        "bottom-right": pifacecad.LCDBitmap([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x18]),
    },
    # stage 1
    {
        "top-left": pifacecad.LCDBitmap([0x0, 0x0, 0xF, 0x8, 0x8, 0x8, 0x8, 0x8]),
        "top-middle": pifacecad.LCDBitmap([0x0, 0x0, 0x1C, 0x4, 0x4, 0xE, 0xA, 0xE]),
        "top-right": pifacecad.LCDBitmap([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
        "bottom-left": pifacecad.LCDBitmap([0x8, 0x8, 0x8, 0x8, 0x8, 0x8, 0x8, 0x1F]),
        "bottom-middle": pifacecad.LCDBitmap([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1F]),
        "bottom-right": pifacecad.LCDBitmap([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x18]),
    ...
    # stage 2
    {
        ...
        "top-right": pifacecad.LCDBitmap([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
        "bottom-left": pifacecad.LCDBitmap([0x8, 0x8, 0x8, 0x8, 0x8, 0x8, 0x8, 0x1F]),
        "bottom-middle": pifacecad.LCDBitmap([0x4, 0x4, 0x4, 0x0, 0x0, 0x0, 0x0, 0x1F]),
        "bottom-right": pifacecad.LCDBitmap([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x18]),
    },
    # stage 3
    {
...
class Hangman(object):
    ...
    def print_hangman(self):
        ...
        self.cad.lcd.write_custom_bitmap(TOP_LEFT_INDEX, stages[self.stage]["top-left"])
...
class HangmanGame(object):
    ...
    def ask_for_letter(self):
        ...
        scanner = pifacecad.tools.LCDScanf(format="Guess: %c%r", cad=self.cad)
